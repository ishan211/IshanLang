...
Example:
```bash
python IshanLang.py example1.il 1 1
```

## Syntax
Programs should be 1 line in length with each opcode seperated by just `-|*|-`.
...
```plaintext
READ-|*|-READ-|*|-SUB-|*|-JUMP.EQ.0 L1-|*|-PRINT "not equal"-|*|-HALT-|*|-L1: -|*|-PRINT "equal" -|*|-HALT
```
...
```plaintext
READ-|*|-PUSH 1-|*|-ADD-|*|-JUMP.EQ.0 L1-|*|-LOOP: -|*|-PUSH 2-|*|-SUB-|*|-JUMP.EQ.0 L1-|*|-JUMP.GT.0 LOOP-|*|-PRINT "even"-|*|-HALT-|*|-L1: -|*|-PRINT "odd"-|*|-HALT
```
